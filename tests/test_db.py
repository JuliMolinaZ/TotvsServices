...
class TestDBOperations(unittest.TestCase):
    ...
    def test_insertar_picklist_success(self, mock_logger):
        ...
        mock_logger.info.assert_called_with("Insertado PickListTest con PickListID: 1")
    ...
    def test_insertar_picklist_detalle_success(self, mock_logger):
        ...
        mock_cursor.execute.assert_called_once()
        mock_logger.info.assert_called_with("Insertado PickListDetalleTest con PickListDetalleID: 10")
