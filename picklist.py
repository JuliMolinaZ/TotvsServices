...
def insertar_picklist(cursor, data):
    ...
    try:
        ...
        logging.info(f"Insertado PickListTest con PickListID: {picklist_id}")
        return picklist_id
    except mysql.connector.Error as err:
        logging.error(f"Error al insertar en PickListTest: {err}")
        raise
...
def insertar_picklist_detalle(cursor, picklist_id, data):
    ...
    try:
        ...
        logging.info(f"Insertado PickListDetalleTest con PickListDetalleID: {detalle_id}")
    except mysql.connector.Error as err:
        logging.error(f"Error al insertar en PickListDetalleTest: {err}")
        raise
